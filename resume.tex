...
%%      \footerphone{(555) 555-5555} \
        % \footerlink{http://patriciarealini.com/} \
        \footeremail{hello@patriciarealini.com}
    } \\
    \small{\emph{
        \LaTeX source for this resum$\acute{e}$ located at \href{https://github.com/patriciarealini/resume}{github.com/patriciarealini/resume}
    }}
    \end{spacing}
}
